        ...
        case -1:
          if (nextRef.current) {
            ref.current.animate({
              ...
              pageIndex = newIndex;
              ref.current.style.transform = "skewY(0deg) scaleX(1)";
              setIndex(newIndex);
            };
          }
        ...
        case 1:
          if (prevRef.current) {
            prevRef.current.animate({
              transform: ["skewY(".concat(-90 * (1 - c), "deg) scaleX(").concat(c, ")"), 'skewY(0deg) scaleX(1)']
            }, {
              duration: 500 * (1 - c),
              easing: 'ease-out'
            }).onfinish = function () {
              pageIndex = newIndex;
              console.log(prevRef);
              prevRef.current.style.transform = "skewY(-90deg) scaleX(0)";
              setIndex(newIndex);
            };
          }
...
//# sourceMappingURL=novel.js.5849dce97eb1a22acffb.hot-update.js.map