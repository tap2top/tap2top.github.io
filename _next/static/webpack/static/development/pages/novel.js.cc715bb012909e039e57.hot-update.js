    ...
    var panend = function panend(e) {
      ...
      switch (arrow) {
        case -1:
          if (nextRef.current) {
            ref.current.animate({
              transform: ["skewY(".concat(90 * c, "deg) scaleX(").concat(1 + c, ")"), 'skewY(0deg) scaleX(1)']
            }, {
              duration: 500 * (1 + c),
              easing: 'ease-out'
            }).onfinish = function () {
...
//# sourceMappingURL=novel.js.cc715bb012909e039e57.hot-update.js.map